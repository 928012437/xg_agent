...
class build_XgAgentPage extends PluginPfMobilePage
{
	public function main()
	{
		...
		$poster = pdo_fetch('select * from ' . tablename('xg_agent_postera') . ' where keyword2=:keyword and uniacid=:uniacid limit 1', array(':keyword' => $content, ':uniacid' => $_W['uniacid']));
