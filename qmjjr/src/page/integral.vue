    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-header-text"><i class="iconfont" style='font-size:18px'>&#xe675;</i> 我的积分</div>
                <div>{{leiji}}分</div>
            </div>
        </div>
        ...
        <div class="content goods-wrap ">
            <!-- <div  class="jl"> -->
            <pay-cell :payData='payData' :payCount='payCount' :index='index'
                      styles='font-size:18px;margin-top:6px;color:#FE8A19'></pay-cell>
        </div>
