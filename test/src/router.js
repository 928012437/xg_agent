...
import EditCard from './page/edit-card.vue'
...
export const routes=[
	{path:'/',component:App,
		children:[
			...
			{path:'customer/customerinfo',component:CustomerInfo,name:'客户详情'},
			...
			{path:'home/bankcard/editcard',component:EditCard,name:'编辑银行卡'},
			...
			{path:'rigister',component:Register,name:'rigister'},
			{path:'checksign',component:checkSign,name:'checksign'},
			{path:'checksign/sign',component:Sign,name:'账号登录'},
