...
<div class="content">
	...
	<div class="content overdue-wrapper">
	<div>选中的客户数组{{customerGroup}}</div>
	<div>选中的销售数组{{checkedSaleGrounp}}</div>
	<div>{{checkedSale}}</div>
		<over checkedGroup='checkedGroup'>
...
export default{
	...
	computed:{
		...
		checkedSale(){
			...
			this.checkedGroup.saleGrounp=checkedSaleGrounp;
