...
class Excel_XgAgentModel
{
	...
	public function export($list, $params = array())
	{
		...
		$excel = new PHPExcel();
		$excel->getProperties()->setCreator('炫果经纪人')->setLastModifiedBy('炫果经纪人')->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
	...
	public function import($excefile)
	{
		...
		$path = IA_ROOT . '/addons/xg_agent/data/tmp/';
